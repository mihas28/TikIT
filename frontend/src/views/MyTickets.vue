...
import { loadMyTickets } from '@/api/api';
...
onMounted(async () => {
  ...
  tickets.value = await loadMyTickets(currentUserId.value);
...
// **Preusmeritev na user Ticket**
const openTicket = (ticketId: number) => {
  router.push({ name: 'TicketUser', params: { id: ticketId } });
};
...
<template>
    ...
    <div v-if="isLoading" class="content-wrapper">
      <p>Nalaganje mojih zahtevkov...</p>
    </div>

    <div v-if="!isLoading" class="content-wrapper">
      <h3>Seznam mojih zahtevkov</h3>
